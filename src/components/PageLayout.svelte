...
>
	...
	>
		<div class="px-5 sm:px-8 md:px-24 mx-auto max-w-6xl">
			<h1
				class="pt-6 sm:pt-12 md:pt-16 text-[2.25rem] leading-[1.12] md:text-5xl md:leading-tight lg:text-6xl font-heading font-[550] mb-6 {centerTitle
					? 'text-center'
					: ''}"
			>
				{#if heroIcon}
