...
<main
	class="min-h-screen bg-maia_white dark:bg-maia_black dark:text-maia_white relative overflow-hidden"
>
	...
	>
		<div class="px-8 md:px-24 mx-auto max-w-6xl">
			<h1
				class="pt-16 text-4xl md:text-5xl lg:text-6xl font-heading font-[550] mb-6 {centerTitle
					? 'text-center'
					: ''}"
			>
				{#if heroIcon}
