...
<main class="min-h-screen bg-maia_white dark:bg-maia_black dark:text-white">
    ...
    <div class="px-8 md:px-24">
        <h1 class="pt-36 md:pt-36 text-4xl md:text-6xl md:w-2/3 font-heading font-[550]">We're a group of MIT students conducting research to <span class="text-purple-600 dark:text-purple-500">reduce risk from advanced AI</span>.</h1>
        ...
        <a href="https://www.mitalignment.org/aisf-ml"><h2 class="mt-8 w-fit text-lg underline bg-purple-100 text-purple-600 dark:bg-purple-700 dark:text-purple-200 rounded-md py-2 px-4">Apply to our technical AI safety program &rarr;</h2></a>
        <a href="https://www.mitalignment.org/aisf-policy"><h2 class="w-fit mt-4 text-lg underline bg-fuchsia-100 text-fuchsia-600 dark:bg-fuchsia-700 dark:text-fuchsia-200 rounded-md py-2 px-4">Apply to our policy AI safety program &rarr;</h2></a>
