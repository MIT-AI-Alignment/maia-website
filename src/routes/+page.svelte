...
<main class="flex min-h-screen bg-maia_white">
    <Navbar />
    <div class="px-24">
        ...
        <a href="https://www.mitalignment.org/aisf-ml"><h2 class="pt-12 text-lg underline">Apply to our technical AI safety program &rarr;</h2></a>
        <a href="https://www.mitalignment.org/aisf-policy"><h2 class="pt-2 text-lg underline">Apply to our policy AI safety program &rarr;</h2></a>
