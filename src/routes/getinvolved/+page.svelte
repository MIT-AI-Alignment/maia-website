...
<main class="min-h-screen bg-maia_white dark:bg-maia_black dark:text-maia_white">
	...
	<div class="px-8 md:px-24">
		...
		<p class="pt-4">
			Learn the basics of AI safety and how to prevent harm from AI systems. MAIA offers two intro
			tracks, focusing on technical and policy respectively. We recommend applying to the program
			you are most interested in. You can participate in both tracks simultaneously.
		</p>
		...
		<p class="mt-2">
			Participants meet weekly in small sections facilitated by a TA that is a graduate student or
			an upperclassman with experience in AI safety research. Dinner is provided, and no work is
			assigned outside of weekly meetings. Our curriculum is based on <a
				href="https://course.aisafetyfundamentals.com/alignment"
				class="underline">a course developed by OpenAI researcher Richard Ngo</a
			>.
		</p>
		<p
		...
		>
			Apply <a href="https://airtable.com/appVPLkc1QXD4A8IY/shrf4mFXsuSmZHbyc" class="underline"
				>here</a
		...
		<p class="pt-2">
			The policy track of AI Safety Fundamentals is a seven-week reading group on the foundational <b
				>governance and policy challenges</b
			>
			posed by advanced AI systems. Topics discussed include
			<a href="https://arxiv.org/abs/2303.11341" class="underline"
				>the proliferation of dangerous AI models</a
			>,
			<a class="underline" href="https://arxiv.org/abs/2309.11690"
				>AI-induced explosive economic growth</a
			>, and
			<a class="underline" href="https://epochai.org/blog/compute-trends"
				>methods for predicting when transformative AI will be developed</a
			>.
		</p>
		<p class="mt-2">
			Participants meet weekly in small sections facilitated by a TA that is a graduate student or
			an upperclassman with relevant experience. Dinner is provided, and no work is assigned outside
			of weekly meetings. Our curriculum is based on <a
				href="https://course.aisafetyfundamentals.com/governance"
				class="underline">a course developed by experts on AI policy.</a
			>
		</p>
		<p
		...
		<h3 class="pt-4">
			Every semester, MAIA and the AI Student Safety Team at Harvard (<a href="http://haist.ai"
				>AISST</a
			>) collaborate to run weekend workshops on AI safety. We gather students, professors, and
		...
		<p class="mt-4">
			...
			>), hosts <a href="https://www.cbai.ai/ml-bootcamp">ML Bootcamps</a> outside of semester time,
			aimed at quickly getting students up to speed in deep learning and developing skills useful for
			conducting AI safety research in the real world.
		</p>
		<p class="mt-2 mb-2">
			The bootcamps are in-person, with teaching assistants experienced with ML and AI safety
			research. We follow the highly-rated MLAB (Machine Learning for Alignment) curriculum designed
			by Redwood Research, which provides a <b
				>thorough, hands-on introduction to state-of-the-art ML techniques</b
