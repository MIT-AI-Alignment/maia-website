...
<main class="min-h-screen bg-maia_white">
    ...
    <div class="px-24">
        ...
        <h3 class="pt-8 text-3xl font-heading text-purple-600">Machine Learning track</h3>
        <p class="pt-2">
            ...
            <p class="font-heading underline text-lg mt-4 bg-purple-100 text-purple-600 rounded-md p-2 w-fit">
            Apply here by Wednesday, February 14th, 11:59pm EST.
        </p>
        <h3 class="pt-8 text-3xl font-heading text-fuchsia-600">Policy track</h3>
        <p class="pt-2">
            ...
            <p class="font-heading underline text-lg mt-4 bg-fuchsia-100 text-fuchsia-600 rounded-md p-2 w-fit">
            Apply here by Wednesday, February 14th, 11:59pm EST.
        </p>
